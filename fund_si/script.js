...
let funcionarios = [
    {nome: "Marcio", funcao: "Caixa", salario: 2320.30, cpf: "915.371.270-63"},
    {nome: "Jose", funcao: "Caixa", salario: 2290.30, cpf: "025.515.770-39"},
    {nome: "Dalmo", funcao: "Gerente", salario: 14020.30, cpf: "928.721.000-40"},
    {nome: "Marco", funcao: "Farmacêutico", salario: 4.461, cpf: "842.019.690-88"},
    {nome: "Edgar", funcao: "Farmacêutico", salario: 4.461, cpf: "159.159.159-52"},

];

let medicamentos = [
    {nome: "Escitalopram", preco: 39, composicao: "Ecitalopram - 10g"},
    {nome: "Gadernal", preco: 33, composicao: "Fenobarbital - 50g"},
    {nome: "Multigrip", preco: 20, composicao: "Paracetamol - 400mg"},
    {nome: "Tadalafila", preco: 25, composicao: "Lactose monoidratada"},
    {nome: "Percoide", preco: 49, composicao: "Prednisolona"},

];

let clientes = [
    {nome: "Joâo", email: "Joaoface@gmail.com", cpf: "116.365.830-83"},
    {nome: "Gregor", email: "RoachSamsa@gmail.com", cpf: "880.254.250-37"},
    {nome: "Joseph", email: "EndlessProcess@gmail.com", cpf: "718.204.810-85"},
    {nome: "Margarida", email: "FaustianPrice@gmail.com", cpf: "313.139.840-00"},
    {nome: "Elizabeth", email: "QueenE@gmail.com", cpf: "902.515.180-94"},
...
//Funções de editar: necessário para puxar as informações preexistentes
...
function listaFuncionarios(funcionarios){
    ...
    if (funcionarios.length == 0){
        filho.innerHTML += `<h2 class="d-flex align-items-center mt-3">Não há registros!</h2>`
        constroeLista(filho);
    }
    else {
